...
(:domain BLOCKS)
(:objects A - block C - block L - block D - block J - block H - block K - block O - block N - block G - block I - block F - block B - block M - block E - block)
(:INIT ( and (CLEAR E) (CLEAR M) (CLEAR B) (CLEAR F) (CLEAR I) (ONTABLE G)
