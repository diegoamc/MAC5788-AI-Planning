...
(:domain BLOCKS)
(:objects J - block B - block K - block A - block D - block H - block E - block N - block C - block F - block L - block M - block I - block O - block G - block)
(:INIT ( and (CLEAR G) (CLEAR O) (ONTABLE I) (ONTABLE M) (ON G L) (ON L F) (ON F C)
